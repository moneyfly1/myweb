...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'tutorials', name: 'SoftwareTutorials', component: () => import('@/components/tutorials/SoftwareTutorials.vue'), meta: { title: '客户端中心', breadcrumb: [{ title: '首页', path: '/dashboard' }, { title: '客户端中心', path: '/tutorials' }] } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'selfhost-nodes', name: 'AdminSelfHostNodes', component: () => import('@/views/admin/SelfHostNodes.vue'), meta: { title: '自建节点管理', breadcrumb: [{ title: '管理后台', path: '/admin/dashboard' }, { title: '自建节点管理', path: '/admin/selfhost-nodes' }] } },
