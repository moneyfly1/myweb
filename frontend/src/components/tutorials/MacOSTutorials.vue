<template>
  <div class="macos-tutorials">
    <el-collapse v-model="activeNames">
      ...
      <el-collapse-item title="Clash Verge" name="clash-verge-macos">
        <div class="tutorial-content">
          <h3>1. 软件下载</h3>
          <p>点击上方"立即下载"按钮下载 Clash Verge 最新版本。</p>
          <h3>2. 安装步骤</h3>
          <ol>
            <li>下载完成后，双击 .dmg 文件</li>
            <li>将 Clash Verge 拖拽到 Applications 文件夹</li>
            <li>在应用程序文件夹中找到 Clash Verge 并双击启动</li>
            <li>首次运行可能提示"无法验证开发者"，请按以下步骤操作：
              <ul>
                <li>打开"系统偏好设置" → "安全性与隐私"</li>
                <li>点击"仍要打开"按钮</li>
          ...
          <div class="subscription-methods">
            ...
            <h4>方法二：一键导入</h4>
            <ol>
              <li>在用户仪表盘中，点击"Clash Verge"按钮</li>
              <li>选择"一键导入"</li>
              <li>软件会自动打开并导入配置</li>
            </ol>
          </div>
