...
uninstall_aliyun_aegis() {
    ...
    if command -v iptables &> /dev/null; then
        log "屏蔽阿里云盾 IP..."
        for rule in \
            "140.205.201.0/28" "203.0.113.70/29" "203.0.113.71/28" \
            "140.205.225.192/29" "203.0.113.74/30" "140.205.225.184/29" \
            "203.0.113.72/32" "203.0.113.77/32" "203.0.113.76/32" \
            "203.0.113.73/32" "203.0.113.75/32"; do
