...
return static function (Slim\App $app): void {
    ...
    $app->group('/admin', static function (RouteCollectorProxy $group): void {
        ...
        // Node Collector
        $group->get('/node/collector', App\Controllers\Admin\NodeController::class . ':collector');
        $group->get('/node/collector/config', App\Controllers\Admin\NodeController::class . ':collectorConfig');
        $group->post('/node/collector/config', App\Controllers\Admin\NodeController::class . ':collectorConfig');
        $group->post('/node/collector/run', App\Controllers\Admin\NodeController::class . ':collectorRun');
        $group->get('/node/collector/logs', App\Controllers\Admin\NodeController::class . ':collectorLogs');
        $group->get('/node/collector/status', App\Controllers\Admin\NodeController::class . ':collectorStatus');
        // Ticket
