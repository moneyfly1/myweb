...
echo -e "${RED}如果宝塔面板中 PHP 显示为"静态"，请按以下步骤修改：${NC}"
echo -e "${YELLOW}  1. 登录宝塔面板${NC}"
echo -e "${YELLOW}  2. 网站 → board.moneyfly.club → 设置${NC}"
echo -e "${YELLOW}  3. 点击左侧"PHP"${NC}"
echo -e "${YELLOW}  4. 将 PHP 版本从"静态"改为"PHP 8.2"${NC}"
echo -e "${YELLOW}  5. 保存${NC}"
echo ""
echo -e "${YELLOW}请测试访问: http://${DOMAIN}${NC}"
echo -e "${YELLOW}如果仍有问题，请检查:${NC}"
echo -e "${YELLOW}  1. 宝塔面板中站点配置是否正确${NC}"
echo -e "${YELLOW}  2. PHP 版本是否选择正确（PHP 8.2，不能是"静态"）${NC}"
echo -e "${YELLOW}  3. 站点根目录是否指向: ${INSTALL_DIR}/public${NC}"
echo -e "${YELLOW}  4. 伪静态规则是否已设置${NC}"
