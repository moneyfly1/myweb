...
func TestDedicatedSubscriptionFormatsGenerateUsableOutput(t *testing.T) {
	...
	proxies := []*ProxyNode{
		...
		{Name: "VMess Node", Type: "vmess", Server: "vmess.example.com", Port: 443, UUID: "00000000-0000-4000-8000-000000000076", Cipher: "auto", TLS: true, Network: "ws", Options: map[string]any{"ws-opts": map[string]any{"path": "/ws", "headers": map[string]any{"Host": "ws.example.com"}}}},
		{Name: "VLESS Node", Type: "vless", Server: "vless.example.com", Port: 443, UUID: "00000000-0000-4000-8000-000000000028", TLS: true},
		{Name: "TUIC Node", Type: "tuic", Server: "tuic.example.com", Port: 443, UUID: "00000000-0000-4000-8000-000000000028", Password: "tuic-secret", TLS: true},
	...
	for _, want := range []string{
		...
		"VMess Node = vmess, vmess.example.com, 443, username=00000000-0000-4000-8000-000000000076, tls=true, vmess-aead=true, ws=true, ws-path=/ws, sni=ws.example.com, ws-headers=Host:ws.example.com",
	...
	for _, want := range []string{
		...
		"vmess = vmess.example.com:443, method=chacha20-ietf-poly1305, password=00000000-0000-4000-8000-000000000076, obfs=wss, obfs-host=ws.example.com, obfs-uri=/ws",
		"[policy]",
	} {
	...
	for _, want := range []string{
		...
		`VMess Node = vmess,vmess.example.com,443,chacha20-ietf-poly1305,"00000000-0000-4000-8000-000000000076",over-tls=true,transport=ws,path=/ws,host=ws.example.com`,
		"[Remote Rule]",
	} {
