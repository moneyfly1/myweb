...
func TestDedicatedSubscriptionFormatsGenerateUsableOutput(t *testing.T) {
	...
	proxies := []*ProxyNode{
		...
		{Name: "VMess Node", Type: "vmess", Server: "vmess.example.com", Port: 443, UUID: "00000000-0000-4000-8000-000000000076", Cipher: "auto", TLS: true},
	...
	for _, want := range []string{
		...
		"VMess Node = vmess, vmess.example.com, 443, username=00000000-0000-4000-8000-000000000076",
		"VLESS Node = vless, vless.example.com, 443, username=00000000-0000-4000-8000-000000000028",
	...
	for _, want := range []string{
		...
		"vmess=vmess.example.com,443,method=auto,password=00000000-0000-4000-8000-000000000076",
		"[policy]",
	} {
	...
	for _, want := range []string{
		...
		"VMess Node = VMess, vmess.example.com, 443, 00000000-0000-4000-8000-000000000076",
		"VLESS Node = VLESS, vless.example.com, 443, 00000000-0000-4000-8000-000000000028",
		"[Remote Rule]",
	} {
